...
//score 1486~1600 : blackout
    ...
    if(mode == 0 || mode == 1){
      ...
      if(Alpha == true){
        Alpha = false;      //本当はfalse
        if(alt <= 100){
          image(seishi_top,200,alt,100,30.4);
        }
        if(alt > 100){
          alt -= alt_upspeed;
          if(alt > 100 && alt <= 180){
            image(seishi_top,200,alt,100,30.4);
          }else if(alt > 180 && alt <= 380){
            image(seishi_middle,200,alt,100,30.4);
          }else if(alt > 380){
            image(seishi_bottom,200,alt,100,30.4);
          }
        }
      }else{
        alt += alt_downspeed;
      ...
      if(alt > 514){
        ...
        image(seishi_dead,200,alt,100,30.4);
        scene = 4;
        alt = 100;
        count = 300;
      }else if(score>3000){
